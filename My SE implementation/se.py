...
measurements = {}
measurements['Measurement No. i'] = [1,2,3,4,5,6,7,8]
measurements['Type'] = meas['meas_name']
measurements['Measured Value (pu)']=meas['value']
measurements['Estimated Value (pu)']=[0.8930, 1.1711, -0.4959, 0.5588]
measurements['Residual (pu)']=
final= pd.DataFrame(measurements).set_index('Measurement No. i')
final
