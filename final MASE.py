...
#INDUSTRIAL
pp.create_measurement(net, 'p', 'bus', 0.75, .001,  element = 24)

#COMMERCIAL
pp.create_measurement(net, 'p', 'bus', 0.35, .001,  element = 33)

#RESIDENTIAL
pp.create_measurement(net, 'p', 'bus', 0.02, .001,  element = 12)
pp.create_measurement(net, 'p', 'bus', 0.03, .001,  element = 18)

#MIXED
pp.create_measurement(net, 'p', 'bus', 0.45, .001,  element = 57)
